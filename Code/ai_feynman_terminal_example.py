...
parser.add_argument("--BF_try_time", type=float, default=180, help="Time limit for each brute force code call")
parser.add_argument("--BF_ops_file_type", type=str, default="19ops.txt", help="File containing the symbols to be used in the brute force code")
...
parser.add_argument("--NN_epochs", type=int, default=2500, help="Number of epochs for the training")
